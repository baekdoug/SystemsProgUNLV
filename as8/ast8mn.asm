...
;  order (small to large to small).  Uses the shell sort algorithm (from asst #7).

;  The second procedure, basicStats(), finds the minimum, median, maximum,
...
;  The third procedure, correlationCoefficient(), to computes the
...
extern	shellSort, basicStats, corrCoefficient
...
;  call shellSort(xList1, len1)
	mov	rdi, xList1
	mov	esi, dword [len1]
	call	shellSort

;  call shellSort(yList1, len1)
	mov	rdi, yList1
	mov	esi, dword [len1]
	call	shellSort
...
;  call shellSort(xList2, len2)
	mov	rdi, xList2
	mov	esi, dword [len2]
	call	shellSort

;  call shellSort(yList2, len2)
	mov	rdi, yList2
	mov	esi, dword [len2]
	call	shellSort
...
;  call shellSort(xList3, len3)
	mov	rdi, xList3
	mov	esi, dword [len3]
	call	shellSort
	add	rsp, 16

;  call shellSort(yList3, len3)
	mov	rdi, yList3
	mov	esi, dword [len3]
	call	shellSort
